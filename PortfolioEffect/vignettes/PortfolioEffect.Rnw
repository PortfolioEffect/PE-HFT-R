...
\vspace{0.3cm}
{\Huge\bfseries PortfolioEffect Package \\ for R Software\\ }
% ----------------------------------------------------------------
\vspace{1.5cm}
...
PortfolioEffect client for R relies on the rJava package, which assumes that Java runtime is installed and configured on your system.
...
If you manually downloaded PortfolioEffect package (you don't want to use CRAN
...
or directly from \href{https://www.portfolioeffect.com}{www.portfolioeffect.com}
account downloads section.
...
\href{http://www.portfolioeffect.com/registration}{www.portfolioeffect.com/registration}.\par
...
Run the following commands to set your account API credentials for the PortfolioEffect R Package installed. 
...
this procedure if you change your account password or install PortfolioEffect package
on another computer.
\begin{lstlisting}
...
Method
\href{http://www.portfolioeffect.com/docs/platform/quant/functions/general-functions/portfolio-create}{portfolio\_create()}.
...
\href{http://www.portfolioeffect.com/docs/platform/quant/functions/general-functions/portfolio-add-position}{portfolio\_addPosition()}
...
\href{http://www.portfolioeffect.com/docs/platform/quant/instruments}{all NASDAQ traded equites}.
