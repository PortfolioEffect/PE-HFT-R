...
# PortfolioEffect Quant - HFT Package for R 
R package for high frequency trading (HFT) strategy backtests, intraday portfolio analysis and portfolio optimization.
...
If you manually installing PortfolioEffectHFT package (you don't want to use CRAN
